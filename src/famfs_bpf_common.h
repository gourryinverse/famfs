#ifndef FAMFS_BPF_COMMON_H
#define FAMFS_BPF_COMMON_H

#ifndef __bpf__
#include <linux/types.h>
#endif

#define FAMFS_BPF_FMAP_MAX 32768
...
struct famfs_meta_interleaved_ext_bpf {
	...
	__u64 fie_nbytes;
	struct famfs_meta_simple_ext_bpf ie_strips[FAMFS_BPF_MAX_STRIPS]; /* inlined */
};
